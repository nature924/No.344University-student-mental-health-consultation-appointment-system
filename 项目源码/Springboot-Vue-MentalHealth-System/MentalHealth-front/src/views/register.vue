    ...
    <div style="backgroundImage: url('/xinlijiankangxitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生心理健康咨询预约系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="心理老师姓名" class="input" v-if="tableName=='psychologyer'">
                            <el-input v-model="ruleForm.psychologyerName" autocomplete="off" placeholder="心理老师姓名"  />
                        </el-form-item>
                        <el-form-item label="心理老师手机号" class="input" v-if="tableName=='psychologyer'">
                            <el-input v-model="ruleForm.psychologyerPhone" autocomplete="off" placeholder="心理老师手机号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='psychologyer'">
                            <el-input v-model="ruleForm.psychologyerEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.psychologyerName)&& 'psychologyer'==this.tableName){
                                this.$message.error('心理老师姓名不能为空');
                                return
                            }
                             if('psychologyer' == this.tableName && this.ruleForm.psychologyerPhone&&(!this.$validate.isMobile(this.ruleForm.psychologyerPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('psychologyer' == this.tableName && this.ruleForm.psychologyerEmail&&(!this.$validate.isEmail(this.ruleForm.psychologyerEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
